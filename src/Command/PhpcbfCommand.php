 ...
 */
class PhpcbfCommand extends BaseCommand {

	protected function configure(): void {
		$this->setName( 'afl:bob:phpcbf' )
			->setDescription( 'Beautify PHP files in plugin folders.' );
	}
		...
		$commands = array(
			new Process(
				array(
					...
					$config['paths']['plugin_dir'] . 'src',
					$config['paths']['plugin_dir'] . 'config',
					$config['paths']['plugin_file'],
				),
